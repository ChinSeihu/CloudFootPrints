...
function povClause(persona: PersonaV2): string {
  ...
  return [
    ...
    "The protagonist is usually the photographer, not automatically the subject being photographed.",
    ...
    "For first-person shots, show at most one hand unless a tripod, timer, phone placed on a table/floor, mirror selfie, or another photographer is explicitly described.",
    "The protagonist may appear sometimes, but not in every image.",
    "If the protagonist appears, use a plausible capture method: casual selfie, mirror/window reflection, back view, side view, timer shot, tripod shot, phone placed on a table/floor, friend-taken snapshot, or group photo.",
...
function buildRules(persona: PersonaV2): string {
  return [
    ...
    "Balance image viewpoints: many solo check-ins should show the protagonist's view, while some may show the protagonist via selfie, timer, tripod, reflection, back view, friend-taken snapshot, group photo, or phone placed on a table/floor.",
    "Do not overuse third-person portraits of the recurring individual.",
