...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: "/splash-logo-02-192.png", type: "image/png", sizes: "192x192" }],
    shortcut: "/splash-logo-02-192.png",
    apple: [{ url: "/splash-logo-02-180.png", sizes: "180x180", type: "image/png" }],
  },
