...
import { walkerplusSource, walkerplusSportsSource } from "./walkerplus";
...
export function getSources(): Source[] {
  return [walkerplusSource, walkerplusSportsSource, jalanSource, tokyoOpenDataSource, connpassSource, sampleFixturesSource];
}
