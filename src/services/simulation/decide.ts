...
- photoDesc 必须写清楚镜头是谁拍的。作为 INS 风生活博主，人物出镜比例应偏高：约 45% 是主观环境/物品画面，约 35% 是镜中/橱窗倒影、定时器、三脚架、手机放在桌上或地上延时拍、自然 pose，约 20% 是朋友帮拍或合照；避免镜头里频繁出现“拿手机自拍/拍照”的动作。
- 主角作为拍摄者时，画面里最多出现一只手；不要写成两只手同时清晰入镜，除非明确是自拍、镜子、定时器、三脚架、手机放置拍摄或朋友拍摄。
- 主角可以出镜，但必须说明合理拍摄方式：朋友同行、合照、朋友帮拍、镜中倒影、橱窗倒影、背影、侧脸、定时器、三脚架、手机放桌上/地上延时拍；出镜时可有日常但时尚的穿搭、妆发和自然 pose。
